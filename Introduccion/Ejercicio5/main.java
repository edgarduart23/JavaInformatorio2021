package JavaInformatorio2021.Introduccion.Ejercicio5;
import java.io.*;
...
public class main {
    public static void main(String[] args) {
        ...
        for (Empleado e: Empleado.obtenerEmpleadoPrimeraLetraApellido(empleados, "D")) {
    ...
    public static List<Empleado> cargarEmpleados() {
        ...
        try {
            file = new File("D:/Aplicaciones/JavaInformatorio2021/JavaInformatorio2021/Introduccion/Ejercicio5/empleados.txt");
